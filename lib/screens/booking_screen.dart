...
//       // Firestore Booking
//       final bookingRef = await FirestoreService().bookCar(
//         carId: widget.carId,
//         startDate: startDate!,
//         endDate: endDate!,
//         userId: user.uid,
...
//       // Navigate to TrackingScreen with the booking ID
//       Navigator.pushReplacement(
//         context,
//         MaterialPageRoute(
//           builder: (context) => TrackingScreen(bookingId: bookingRef.id),
//         ),
//       );
//     } catch (e) {
//       setState(() {
...
import '../providers/auth_provider.dart';
import '../services/firestore_service.dart';
import 'tracking_screen.dart'; // Import the TrackingScreen
